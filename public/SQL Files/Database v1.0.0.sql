...
INSERT INTO `Class` (`Class_ID`, `Name`, `Teacher_ID`, `Teacher_ID2`, `Domain_ID`) VALUES
(1,	'CSCI340',	1,	NULL,	1),
(2,	'TEC: French Existentialism',	2,	NULL,	2),
(3,	'CSCI150',	3,	NULL,	1);
...
INSERT INTO `Question` (`Question_ID`, `Domain_ID`, `Text`) VALUES
